    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 py-12 mt-16">
        ...
        <p className="mt-6 text-lg text-white text-center max-w-2xl">
          Let’s collaborate to build something amazing! Reach out for inquiries, collaborations, or just to say hi.
        </p>
        ...
        >
          <div className="mb-6">
            ...
            <input {...register("name")} type="text" className="w-full p-3 rounded-lg bg-gray-900 text-white border border-gray-700 focus:ring-2 focus:ring-blue-500" />
            {errors.name && <p className="text-red-500 text-sm">{errors.name.message}</p>}
          </div>
          <div className="mb-6">
            <label className="block text-blue-300 font-semibold">Email</label>
            <input {...register("email")} type="email" className="w-full p-3 rounded-lg bg-gray-900 text-white border border-gray-700 focus:ring-2 focus:ring-blue-500" />
            {errors.email && <p className="text-red-500 text-sm">{errors.email.message}</p>}
          </div>
          <div className="mb-6">
            <label className="block text-blue-300 font-semibold">Message</label>
            <textarea {...register("message")} className="w-full p-3 rounded-lg bg-gray-900 text-white border border-gray-700 focus:ring-2 focus:ring-blue-500" rows="5"></textarea>
