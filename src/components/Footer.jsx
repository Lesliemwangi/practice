    ...
    <footer className="bg-gradient-to-br from-blue-900 via-gray-900 to-blue-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <p className="mt-3 text-sm">
              I am a former architect turned software engineer. Passionate about
              creating user-focused digital experiences through design and
              technology.
            </p>
          </div>
        ...
        <div className="mt-8 text-center text-gray-500 text-sm border-t border-gray-700 pt-4">
          &copy; {new Date().getFullYear()} Leslie Wambui Mwangi. All Rights
          Reserved.
        </div>
      </div>
    </footer>
